...
$query_laf_data = sprintf("SELECT time,time2,college,department,grade,student_id,name,tel,class,state,state2 FROM `laf_data` WHERE time BETWEEN '$start'+' 00:00:00' AND '$end'+' 23:59:59' ORDER BY time");
$query_limit_laf_data = sprintf("%s LIMIT %d, %d", $query_laf_data, $startRow_laf_data, $maxRows_laf_data);
$laf_data3 = mysqli_query($conn_LAF,$query_limit_laf_data) or die(mysqli_connect_error());
$row_laf_data3 = mysqli_fetch_assoc($laf_data3);
$totalRows_laf_data3 = mysqli_num_rows($laf_data3);

if (isset($_GET['totalRows_laf_data3'])) {
  $totalRows_laf_data3 = $_GET['totalRows_laf_data3'];
 } else {
  $all_laf_data3 = mysqli_query($conn_LAF,$query_laf_data3);
  $totalRows_laf_data3 = mysqli_num_rows($all_laf_data3);
 }
 $totalPages_laf_data3 = ceil($totalRows_laf_data3/$maxRows_laf_data3)-1;
        ...
        <div class="b">
          ...
          fdow:0
                        ...
                        <tr>
                          ...
                          <td width="500" bgcolor="#104E8B"><div align="center"><span class="style3">拾得人單位</span></div></td>
              ...
              <td width="200" bgcolor="#104E8B"><div align="center"><span class="style3">未領取後續處理</span></div></td>
                      ...
                      <?php if($totalRows_laf_data3>0){?>
             <?php do { ?>
                        <tr valign="top">
                          <td width="300"><div align="center" class="style5"><?php echo $row_laf_data3['time'],$row_laf_data['time2'];?></div></td>
                          <td width="500" class="style5"><div align="center"><?php echo $row_laf_data3['college'],$row_laf_data['department'];?></div></td>
                          <td width="200" class="style5"><div align="center"><?php echo $row_laf_data3['grade'];?></div></td>
              <td width="150" class="style5"><div align="center"><?php echo $row_laf_data3['student_id'];?></div></td>
              <td width="200" class="style5"><div align="center"><?php echo $row_laf_data3['name'];?></div></td>
              <td width="200" class="style5"><div align="center"><?php echo $row_laf_data3['tel'];?></div></td>
              <td width="200" class="style5"><div align="center"><?php echo $row_laf_data3['class'];?></div></td>
              <td width="200" class="style5"><div align="center"><?php echo $row_laf_data3['state'];?></div></td>
              <td width="200" class="style5"><div align="center"><?php echo $row_laf_data3['state2'];?></div></td>
