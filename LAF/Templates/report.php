...
mysqli_select_db($conn_LAF,$database_conn_LAF);
$query_laf_data = sprintf("SELECT time,time2,college,department,grade,student_id,name,tel,class,state,state2 FROM `laf_data` WHERE time BETWEEN '$start' AND '$end' ORDER BY time");
...
//領回
mysqli_select_db($conn_LAF,$database_conn_LAF);
$query_laf_data2 = "Select * from laf_data WHERE time3>='$start' AND time3<='$end' AND temp='N' ORDER BY time DESC";
$laf_data2 = mysqli_query($conn_LAF,$query_laf_data2) or die(mysqli_connect_error());
$row_laf_data2 = mysqli_fetch_assoc($laf_data2);
$totalRows_laf_data2 = mysqli_num_rows($laf_data2);

$laf_data_result2 = array_fill(0, $x_num+1, array_fill(0, $y_num+1, 0));

  do {
      foreach ($x_list as $x_index => $x_value) {
      
    $y_select = explode("-",$row_laf_data2['time3']);
    if($y_select[1]==$x_value){
       
       $laf_data_result2[$x_index][0]++; //y總計

            switch($row_laf_data2['class']){
          case $y_list[0]:  $laf_data_result2[$x_index][1]++; break;
          case $y_list[1]:  $laf_data_result2[$x_index][2]++; break;
          case $y_list[2]:  $laf_data_result2[$x_index][3]++; break;
          case $y_list[3]:  $laf_data_result2[$x_index][4]++; break;
          case $y_list[4]:  $laf_data_result2[$x_index][5]++; break;
          case $y_list[5]:  $laf_data_result2[$x_index][6]++; break;
          case $y_list[6]:  $laf_data_result2[$x_index][7]++; break;
        case $y_list[7]:  $laf_data_result2[$x_index][8]++; break;
          default:      $laf_data_result2[$x_index][9]++; break;}
        }
        }    
  ...
  //類別總計
  for($j=1;$j<=$y_num;$j++){
    for($i=0;$i<$x_num;$i++){$laf_data_result2[$x_num][$j]=$laf_data_result2[$x_num][$j]+$laf_data_result2[$i][$j];}
  }
  for($j=0;$j<$x_num;$j++){
  $laf_data_result2[$x_num][0] = $laf_data_result2[$x_num][0]+$laf_data_result2[$j][0];
  }
      ...
      <div class="t">
        <div class="b">
          ...
          fdow:0
                        ...
                        <p>
                          　　　　　　　　　　
                            <input name="Submit" type="submit" onclick="YY_checkform('form1','start','#^\([0-9]{4}\)\\-\([0-9][0-9]\)\\-\([0-9][0-9]\)$#3#2#1','3','請填入開始時間，或格式不正確!','end','#^\([0-9]{4}\)\\-\([0-9][0-9]\)\\-\([0-9][0-9]\)$#3#2#1','3','請填入結束時間，或格式不正確!');return document.MM_returnValue" value="222222" />
                        </p>
                        <p>
                        ...
                        <tr>
                          <td width="250"><div align="center">類　別　\　月　份</div></td>
                        ...
                        <tr>
                          <td width="250"><div align="center">有價票券</div></td>
                        ...
                        <tr>
                          <td width="250"><div align="center">3C電子<br />
                          </div></td>
                        ...
                        <tr>
                          <td width="250"><div align="center">身分證件<br />
                          </div></td>
                        ...
                        <tr>
                          <td width="250"><div align="center">運動物品</div></td>
                        ...
                        <tr>
                          <td width="250"><div align="center">眼鏡服裝</div></td>
                        ...
                        <tr>
                          <td width="250"><div align="center">文具書籍</div></td>
                        ...
                        <tr>
                          <td width="250"><div align="center">手錶</div></td>
                        ...
                        <tr>
                          <td width="250"><div align="center">鑰匙</div></td>
            ...
            <tr>
                          <td width="250"><div align="center">其它</div></td>
            ...
            <p>&nbsp;</p>
                      <table width="790" border="1" align="center">
                        ...
                        <tr valign="middle">
                          <td colspan="14"><div align="center">
                            <p>國立中央大學　失物招領統計 【領回】 ( <?php echo $start;?> ~ <?php echo $end;?> )                          
                          </div>
                          </p></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td width="250"><div align="center">有價票券</div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[0][1]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[0][1];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[1][1]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[1][1];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[2][1]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[2][1];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[3][1]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[3][1];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[4][1]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[4][1];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[5][1]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[5][1];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[6][1]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[6][1];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[7][1]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[7][1];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[8][1]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[8][1];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[9][1]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[9][1];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[10][1]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[10][1];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[11][1]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[11][1];?></div></td>
                          <td width="60"><div align="center"<?php if($laf_data_result2[12][1]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[12][1];?></div></td>
                        </tr>
                        <tr>
                          <td width="250"><div align="center">3C電子<br />
                          </div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[0][2]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[0][2];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[1][2]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[1][2];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[2][2]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[2][2];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[3][2]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[3][2];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[4][2]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[4][2];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[5][2]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[5][2];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[6][2]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[6][2];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[7][2]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[7][2];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[8][2]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[8][2];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[9][2]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[9][2];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[10][2]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[10][2];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[11][2]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[11][2];?></div></td>
                          <td width="60"><div align="center"<?php if($laf_data_result2[12][2]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[12][2];?></div></td>
                        </tr>
                        <tr>
                          <td width="250"><div align="center">身分證件<br />
                          </div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[0][3]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[0][3];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[1][3]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[1][3];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[2][3]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[2][3];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[3][3]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[3][3];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[4][3]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[4][3];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[5][3]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[5][3];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[6][3]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[6][3];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[7][3]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[7][3];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[8][3]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[8][3];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[9][3]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[9][3];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[10][3]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[10][3];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[11][3]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[11][3];?></div></td>
                          <td width="60"><div align="center"<?php if($laf_data_result2[12][3]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[12][3];?></div></td>
                        </tr>
                        <tr>
                          <td width="250"><div align="center">運動物品</div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[0][4]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[0][4];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[1][4]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[1][4];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[2][4]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[2][4];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[3][4]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[3][4];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[4][4]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[4][4];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[5][4]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[5][4];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[6][4]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[6][4];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[7][4]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[7][4];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[8][4]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[8][4];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[9][4]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[9][4];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[10][4]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[10][4];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[11][4]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[11][4];?></div></td>
                          <td width="60"><div align="center"<?php if($laf_data_result2[12][4]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[12][4];?></div></td>
                        </tr>
                        <tr>
                          <td width="250"><div align="center">眼鏡服裝</div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[0][5]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[0][5];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[1][5]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[1][5];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[2][5]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[2][5];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[3][5]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[3][5];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[4][5]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[4][5];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[5][5]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[5][5];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[6][5]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[6][5];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[7][5]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[7][5];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[8][5]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[8][5];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[9][5]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[9][5];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[10][5]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[10][5];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[11][5]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[11][5];?></div></td>
                          <td width="60"><div align="center"<?php if($laf_data_result2[12][5]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[12][5];?></div></td>
                        </tr>
                        <tr>
                          <td width="250"><div align="center">文具書籍</div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[0][6]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[0][6];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[1][6]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[1][6];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[2][6]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[2][6];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[3][6]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[3][6];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[4][6]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[4][6];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[5][6]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[5][6];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[6][6]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[6][6];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[7][6]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[7][6];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[8][6]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[8][6];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[9][6]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[9][6];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[10][6]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[10][6];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[11][6]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[11][6];?></div></td>
                          <td width="60"><div align="center"<?php if($laf_data_result2[12][6]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[12][6];?></div></td>
                        </tr>
                        <tr>
                          <td width="250"><div align="center">手錶</div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[0][7]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[0][7];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[1][7]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[1][7];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[2][7]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[2][7];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[3][7]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[3][7];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[4][7]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[4][7];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[5][7]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[5][7];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[6][7]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[6][7];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[7][7]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[7][7];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[8][7]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[8][7];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[9][7]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[9][7];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[10][7]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[10][7];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[11][7]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[11][7];?></div></td>
                          <td width="60"><div align="center"<?php if($laf_data_result2[12][7]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[12][7];?></div></td>
                        </tr>
                        <tr>
                          <td width="250"><div align="center">鑰匙</div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[0][8]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[0][8];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[1][8]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[1][8];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[2][8]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[2][8];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[3][8]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[3][8];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[4][8]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[4][8];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[5][8]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[5][8];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[6][8]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[6][8];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[7][8]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[7][8];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[8][8]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[8][8];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[9][8]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[9][8];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[10][8]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[10][8];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[11][8]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[11][8];?></div></td>
                          <td width="60"><div align="center"<?php if($laf_data_result2[12][8]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[12][8];?></div></td>
                        </tr>
            <tr>
                          <td width="250"><div align="center">其它</div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[0][9]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[0][9];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[1][9]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[1][9];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[2][9]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[2][9];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[3][9]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[3][9];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[4][9]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[4][9];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[5][9]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[5][9];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[6][9]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[6][9];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[7][9]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[7][9];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[8][9]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[8][9];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[9][9]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[9][9];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[10][9]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[10][9];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[11][9]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[11][9];?></div></td>
                          <td width="60"><div align="center"<?php if($laf_data_result2[12][9]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[12][9];?></div></td>
                        </tr>
                        <tr>
                          <td width="250"><div align="center">總計</div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[0][0]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[0][0];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[1][0]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[1][0];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[2][0]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[2][0];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[3][0]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[3][0];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[4][0]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[4][0];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[5][0]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[5][0];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[6][0]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[6][0];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[7][0]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[7][0];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[8][0]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[8][0];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[9][0]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[9][0];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[10][0]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[10][0];?></div></td>
                          <td width="40"><div align="center"<?php if($laf_data_result2[11][0]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[11][0];?></div></td>
                          <td width="60"><div align="center"<?php if($laf_data_result2[12][0]>0){echo " style=\"color:#FF0000\"";}?>><?php echo $laf_data_result2[12][0];?></div></td>
                        </tr>
                      </table>
                      <p>&nbsp;</p>
