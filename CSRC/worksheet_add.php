...
$totalRows_csrc_user_list = mysqli_num_rows($csrc_user_list);
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $Q5_1_2 = $_POST['Q5_1_2'];
  $Q7_1_1 = isset($_POST['Q7_1_1']) ? $_POST['Q7_1_1'] : null;
  $Q7_2_1 = isset($_POST['Q7_2_1']) ? $_POST['Q7_2_1'] : null;
  $Q7_3_1 = isset($_POST['Q7_3_1']) ? $_POST['Q7_3_1'] : null;
  $Q7_4_1 = isset($_POST['Q7_4_1']) ? $_POST['Q7_4_1'] : null;
  ...
  $insertSQL = sprintf("INSERT INTO csrc_worksheet (`day`, `week`, `weather`, `duty`, `user`, `NightDuty`, `NightUser`, `vice_duty`, `Q1_1`, `Q1_2_1`, `Q1_2_2`, `Q2_1_1`, `Q2_1_2`, `Q2_2_1`, `Q2_2_2`, `Q2_3`, `Q3_1_1`, `Q3_1_2`, `Q4_1_1`, `Q4_1_2`, `Q5_1_1`, `Q5_1_2`, `Q7_1_1`, `Q7_1_2`, `Q7_2_1`, `Q7_2_2`, `Q7_3_1`, `Q7_3_2`, `Q7_4_1`, `Q7_4_2`, `Q8_1_1`, `Q8_1_2`,`undertaker_0`, `undertaker_1`, `undertaker_1_1`, `undertaker_1_2`, `undertaker_2`, `undertaker_time`, `temp`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",  
                  ...
                  <div class="tl">
					...
					<script>setTimeout("document.form1.submit()",900000)</script>
                      ...
                      fdow:0,
                          ...
                          <tr>
                            <td colspan="2" valign="top"><strong>天氣：</strong><span id="sprytextfield_weather"><input name="weather" type="text" id="weather" /><span class="textfieldRequiredMsg">此項目不可空白。</span></span></td>
                          </tr>
                          <tr>
                            <td colspan="2" valign="top"><strong>值勤官：</strong><?php echo $row_csrc_user['name'];?></td>
                          </tr>
                          <tr>
                            <td colspan="2" valign="top"><strong>夜間值勤官：</strong>
                             <span id="spryselect_NightDuty">
                               <select name="NightDuty" size="1" id="NightDuty">
                                ...
                                <option value="<?php echo $i;?>"><?php echo $name_list[$i]; ?></option>
								<?php } ?>
                             </select>
                            ...
                            <td colspan="2" valign="top"><strong>副值人員：</strong>
                             <span id="spryselect_vice_duty">
                               <select name="vice_duty" size="1" id="vice_duty">
                                <option selected="selected" value="">請選擇..</option>
                                <?php foreach($name_list as $name_out) { ?>
                                <option value="<?php echo $name_out;?>"><?php echo $name_out; ?></option>
								<?php } ?>
                             </select>
                             <span class="selectRequiredMsg">請選取項目。</span></span></p>
							 </td>
                          ...
                          <tr>
                            ...
                            <div align="left">
                              ...
                              <span id="sprytextarea_Q1_1">
                                <textarea name="Q1_1" cols="85" rows="10" id="Q1_1">冊列 10 員，現有 10 員，事故 0 員，實有 10 員。
...
　其他：</textarea>
                              ...
                              <span class="selectRequiredMsg">請選取項目。</span></span></p>
                              <p id="Q1_2_show" align="center" style="display:none">
                              <span id="sprytextarea_Q1_2">
                              <textarea name="Q1_2_2" cols="85" rows="10" id="Q1_2_2"></textarea>
                              <br /><span class="textareaRequiredMsg">此項目不可空白。</span></span></p>
                              </p>
                            </div>                           </td>
                          </tr>
                          <tr>
                            <td colspan="2" valign="top"><div align="left">
                              ...
                              <span class="selectRequiredMsg">請選取項目。</span></span></p>
                              <p id="Q2_1_show" align="center" style="display:none">
                              <span id="sprytextarea_Q2_1">
                              <textarea name="Q2_1_2" cols="85" rows="10" id="Q2_1_2"></textarea>
                              <br /><span class="textareaRequiredMsg">此項目不可空白。</span></span></p>
                              </p>
                              ...
                              <span class="selectRequiredMsg">請選取項目。</span></span></p>
                              <p id="Q2_2_show" align="center" style="display:none">
                              <span id="sprytextarea_Q2_2">
                              <textarea name="Q2_2_2" cols="85" rows="10" id="Q2_2_2"></textarea>
                              <br /><span class="textareaRequiredMsg">此項目不可空白。</span></span></p>
                              </p>
                              
                              <p>　<strong>(三)審核「役期折抵」案：</strong><span id="sprytextfield_Q2_3">
                              <input name="Q2_3" type="text" id="Q2_3" value="合計 0 案。"/>
                          ...
                          <tr>
                            <td colspan="2" valign="top"><div align="left">
                              ...
                              <span class="selectRequiredMsg">請選取項目。</span></span></p>
                              <p id="Q3_1_show" align="center" style="display:none">
                              <span id="sprytextarea_Q3_1">
                              <textarea name="Q3_1_2" cols="85" rows="10" id="Q3_1_2"></textarea>
                              <br /><span class="textareaRequiredMsg">此項目不可空白。</span></span></p>
                              </p>
                              </div>                            </td>
                          </tr>
                          <tr>
                            <td colspan="2" valign="top"><div align="left">
                              ...
                              <span class="selectRequiredMsg">請選取項目。</span></span></p>
                              <p id="Q4_1_show" align="center" style="display:none">
                              <span id="sprytextarea_Q4_1">
                              <textarea name="Q4_1_2" cols="85" rows="10" id="Q4_1_2"></textarea>
                              <br /><span class="textareaRequiredMsg">此項目不可空白。</span></span></p>
                              </p>
                              </div>                            </td>
                          </tr>
                          <tr>
                            <td colspan="2" valign="top"><div align="left">
                              ...
                              <span class="selectRequiredMsg">請選取項目。</span></span></p>
                              <p id="Q5_1_show" align="center" style="display:none">
                              <span id="sprytextarea_Q5_1">
                              <textarea name="Q5_1_2" cols="85" rows="10" id="Q5_1_2">日班：
...
夜班：
                          ...
                          <!-- <tr>
                            <td colspan="2" valign="top"><div align="left">
                              ...
                              <span class="selectRequiredMsg">請選取項目。</span></span></p>
                              <p id="Q7_1_show" align="center" style="display:none">
                              <span id="sprytextarea_Q7_1">
                              <textarea name="Q7_1_2" cols="85" rows="10" id="Q7_1_2"></textarea>
                              <br /><span class="textareaRequiredMsg">此項目不可空白。</span></span></p>
                              </p>
                              ...
                              <span class="selectRequiredMsg">請選取項目。</span></span></p>
                              <p id="Q7_2_show" align="center" style="display:none">
                              <span id="sprytextarea_Q7_2">
                              <textarea name="Q7_2_2" cols="85" rows="10" id="Q7_2_2"></textarea>
                              <br /><span class="textareaRequiredMsg">此項目不可空白。</span></span></p>
                              </p>
                              ...
                              <span class="selectRequiredMsg">請選取項目。</span></span></p>
                              <p id="Q7_3_show" align="center" style="display:none">
                              <span id="sprytextarea_Q7_3">
                              <textarea name="Q7_3_2" cols="85" rows="10" id="Q7_3_2"></textarea>
                              <br /><span class="textareaRequiredMsg">此項目不可空白。</span></span></p>
                              </p>
                              ...
                              <span class="selectRequiredMsg">請選取項目。</span></span></p>
                              <p id="Q7_4_show" align="center" style="display:none">
                              <span id="sprytextarea_Q7_4">
                              <textarea name="Q7_4_2" cols="85" rows="10" id="Q7_4_2"></textarea>
                              <br /><span class="textareaRequiredMsg">此項目不可空白。</span></span></p>
                              </p>
                              </div>                            </td>
                          </tr>
                          <tr> -->
                            <td colspan="2" valign="top"><div align="left">
                              ...
                              <span class="selectRequiredMsg">請選取項目。</span></span></p>
                              <p id="Q8_1_show" align="center" style="display:none">
                              <span id="sprytextarea_Q8_1">
                              <textarea name="Q8_1_2" cols="85" rows="10" id="Q8_1_2"></textarea>
                              <br /><span class="textareaRequiredMsg">此項目不可空白。</span></span></p>
                              </p>
                              </div>
                            </td>
                          ...
                          <tr>
                            <td colspan="2" valign="top"><div align="left">
                              ...
                              <span class="selectRequiredMsg">請選取項目。</span></span></p>
                              <p id="undertaker_show_1" style="display:none">
                              　<strong>所列案件已通知</strong><strong><br /><br />
                              　</strong><span id="sprycheckbox_undertaker">
                              <input type="checkbox" id="undertaker_1" name="undertaker_1" value="Y" />
                              業管單位
                              <span id="sprytextfield_undertaker_1">
                              <input name="undertaker_1_1" type="text" id="undertaker_1_1"/>
                              <span class="textfieldRequiredMsg">此項目不可空白。</span></span>
                              <input type="checkbox" id="undertaker_1_2[]" name="undertaker_1_2[]" value="系所" />
                              系所
                              <input type="checkbox" id="undertaker_1_2[]" name="undertaker_1_2[]" value="導師" />
                              導師
                              <input type="checkbox" id="undertaker_1_2[]" name="undertaker_1_2[]" value="輔導教官" />
                              輔導教官
                              <input type="checkbox" id="undertaker_1_2[]" name="undertaker_1_2[]" value="諮商中心輔導老師" />
                              諮商中心輔導老師<br />　
                              <input type="checkbox" id="undertaker_1_2[]" name="undertaker_1_2[]" value="生輔組" />
                              生輔組
                              <input type="checkbox" id="undertaker_1_2[]" name="undertaker_1_2[]" value="衛保組" />
                              衛保組
                              <input type="checkbox" id="undertaker_1_2[]" name="undertaker_1_2[]" value="國際處" />
                              國際處
                              <input type="checkbox" id="undertaker_1_2[]" name="undertaker_1_2[]" value="環安中心" />
                              環安中心
                              <input type="checkbox" id="undertaker_1_2[]" name="undertaker_1_2[]" value="性平會" />
                              性平會
                              <input type="checkbox" id="undertaker_1_2[]" name="undertaker_1_2[]" value="駐警隊" />
                              駐警隊
                              <span class="checkboxMinSelectionsMsg">未選取。</span></span>
                              <br /><br />
                              　<strong>知悉掌握及賡續處理。                              </strong></p>
                              <p id="undertaker_show_2" align="center" style="display:none">
                              <span id="sprytextarea_undertaker">
                              <textarea name="undertaker_2" cols="85" rows="10" id="undertaker_2"></textarea>
                              <br /><span class="textareaRequiredMsg">此項目不可空白。</span></span></p>
                              </p>
                              </div>                            </td>
                          </tr>
                          <tr>
                            <td colspan="2" valign="top"><strong>是否暫存：</strong>
                              <input name="temp" type="radio" id="temp" value="Y" checked="checked" />
                              是
...
<!--
function check_form() {
	  alert(document.getElementsByName('undertaker_1_2[]'));
