...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $remark = $row_csrc_data['remark'].$row_csrc_user['department'].'-'.$row_csrc_user['name'].' @ '.date('Y-m-d H:i:s')."\n".$_POST['remark']."\n"."\n";

  $updateSQL = sprintf("UPDATE `csrc_data` SET `remark`=%s WHERE `no`=%s",
  ...
  $updateGoTo = "show.php?no=".$_POST['no'];
                      ...
                      <h2>校安狀況詳情</h2>
                        <table width="700" border="0" align="center">
                          ...
                          <tr>
                            ...
                            <td><?php if($row_csrc_data['secret']=='Y'){echo '*****';}else{echo $row_csrc_data['college'];}?></td>
                          </tr>
                          <tr>
                            <td valign="top"><div align="right"><strong>系所：</strong></div></td>
                            <td><?php if($row_csrc_data['secret']=='Y'){echo '*****';}else{echo $row_csrc_data['department'];}?></td>
                          </tr>
                          <tr>
                            <td valign="top"><div align="right"><strong>級別：</strong></div></td>
                            <td><?php if($row_csrc_data['secret']=='Y'){echo '***';}else{echo $row_csrc_data['grade'];}?></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td><?php if($row_csrc_data['secret']=='Y'){$new_name=mb_substr($row_csrc_data['name'], 0, 1,"UTF-8");for($i=1;$i<mb_strlen($row_csrc_data['name'], "UTF-8");$i++){$new_name.='Ｏ';}}else{$new_name=$row_csrc_data['name'];}echo $new_name;?></td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td width="550"><?php echo $row_csrc_data['place'].'-'.$row_csrc_data['place2'];?></td>
                          </tr>
						  ...
						  <tr>
                            <td width="150" valign="top"><div align="right"><strong>新增案件追蹤：</strong></div></td>
<td width="550">
                          ...
                          <tr>
                            <td width="150" valign="top"><div align="right"><strong>登記人：</strong></div></td>
                            <td width="550"><?php echo $row_csrc_user['department'].'-'.$row_csrc_user['name'];?></td>
                          </tr>
                          <tr>
                            <td width="150">&nbsp;</td>
                            <td width="550"><div align="center">
                              <input name="no" type="hidden" id="no" value="<?php echo $row_csrc_data['no'];?>" />
                              <input name="post_date" type="hidden" id="post_date" value="<?php echo date('Y-m-d H:i:s')?>" />
