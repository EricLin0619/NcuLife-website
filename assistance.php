...
<head>
    ...
    <script type="text/javascript" src="javascript/switchTab.js"></script>
</head>
<style>
        .bg-green {
        ...
        <div class="content" style="margin-top: 15px; margin-bottom: 15px;">
            ...
            <div class="tab-content">
                <div id="section1" class="container tab-pane active">
                    <a href="download/國立中央大學學生工讀助學辦法(民國112年6月19日修訂).pdf" class="list-group-item list-group-item-action">國立中央大學學生工讀助學辦法(民國112年6月19日修訂)</a>
                </div>
            </div>
        </div>
        <br>
